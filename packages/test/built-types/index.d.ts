...
export declare const Text: import('@implydata/stitches-react/types/styled-component').StyledComponent<
	'span',
	{
	...
	import('@implydata/stitches-react/types/css-util').CSS<
		...
		import('@implydata/stitches-react/types/config').DefaultThemeMap,
		{
			...
			bbrr: (
				value: import('@implydata/stitches-react/types/css-util').WithPropertyValue<'borderBottomRightRadius'>,
			) => {
			...
			backgroundClip: (
				value: import('@implydata/stitches-react/types/css-util').WithPropertyValue<'backgroundClip'>,
			) => {
