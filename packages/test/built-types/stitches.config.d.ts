import type * as Stitches from '@implydata/stitches-react'
export type { VariantProps } from '@implydata/stitches-react'
export declare const styled: {
	...
	>(
		...
		selector: string
			...
			? import('@implydata/stitches-react/types/stitches').ThemeTokens<Argument1, ''>
			: import('@implydata/stitches-react/types/stitches').ThemeTokens<Argument0, ''>),
	getCssText: () => string,
	keyframes: (style: {
		[offset: string]: import('@implydata/stitches-react/types/css-util').CSS<
			{
				bp1: '(min-width: 520px)'
				bp2: '(min-width: 900px)'
				bp3: '(min-width: 1200px)'
...
export declare const darkTheme: string & {
	className: string
	selector: string
} & import('@implydata/stitches-react/types/stitches').ThemeTokens<
		{
			colors: {
				hiContrast: string
				loContrast: string
