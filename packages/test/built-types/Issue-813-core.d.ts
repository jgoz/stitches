...
export declare const config: {
	...
	css: {
		...
		}) => import('@implydata/stitches-core/types/stitches').CssFunctionType<
			{},
			{
				colors: {
					primary: string
...
export declare const box: import('@implydata/stitches-core/types/styled-component').CssComponent<
	never,
	{},
	{},
	import('@implydata/stitches-core/types/css-util').CSS<
		{},
		{
			colors: {
				primary: string
